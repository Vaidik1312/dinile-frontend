...
function Home() {
  ...
  return (
    <>
        ...
        <div className="home-container">
          ...
          <div className="row">
            <OwlCarousel className="owl-theme" loop nav={true} {...options}>
              <div className="items">
                <div
                  className="col-xl-2 col-lg-4 col-md-4 col-sm-4 col-12"
                  style={{ width: "100%" }}
                >
            ...
            <div className="col-12 col-xl-4 col-lg-4  col-md-12 col-sm-12 col-xs-6 ">
              <div className="explore-content">
                ...
                <p>
                  ...
                  Ullam laudantium officia voluptatum culpa, veniam corrupti
                  fugiat aspernatur! Ducimus recusandae officiis repellat
                  asperiores cupiditate animi rerum, odio, nisi omnis quo
                  dolorem.ˀ
                </p>
              </div>
            </div>
      ...
      <section className="section6 section-padding-y">
        <div className="row">
          ...
          <div className="col-6 col-xl-6 col-lg-6 col-md-4">
            <div>
              <img
                src={require("../Assets/Rectangle 155.png")}
                alt=""
                className="img-fluid"
              />
            </div>
      ...
      <section className="section7 dflex section-padding-y ">
        <div className="row-6">
        ...
        <div className="row-6">
          ...
          <div className="col-12">
            <div>
              <img
                src={require("../Assets/Group 1446.png")}
                alt=""
                className="img-fluid"
              />
            </div>
          ...
          <div className="row">
            <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
              <div className="main-item">
                <img
                  src={require("../Assets/Group 1382.png")}
                  className="img-fluid"
                  alt=""
                />
              </div>
            ...
            <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
              <div className="handimage">
                <h1 className="handcraftext">Handcrafted in Seattle</h1>
                <p className="handcrafpar">
                  Our highly skilled artisans exceed industry standards with
                  sparkling GIA-graded natural diamonds, the finest-quality
                  materials and outstanding engagement ring design at an amazing
                  value.
                </p>
                <button type="button" class="btn btn-outline-secondary btnbutton">
                History of Dinile
                </button>
              </div>
            </div>
